...
const SERVICES = [
  ...
  'Planejamento tributário (Fator R e equiparação hospitalar)',
  ...
  'Registro nos conselhos de classe (CRM, CRO, CRP, CREFITO...)',
  'Certificado digital',
          ...
          <Grid xs={12} md={5}>
            <m.div variants={varFade().inLeft}>
              ...
              <Typography sx={{ color: 'text.secondary', lineHeight: 1.8, mb: 3 }}>
                Da abertura do CNPJ ao planejamento tributário avançado: cuidamos de toda a rotina
                contábil, fiscal e trabalhista do seu consultório ou clínica.
              </Typography>

              <Card
                sx={{
                  p: 3,
                  bgcolor: alpha('#0096D9', 0.06),
                  border: `1px dashed ${alpha('#0096D9', 0.3)}`,
                }}
              >
