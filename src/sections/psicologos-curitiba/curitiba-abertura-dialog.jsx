...
/** Modal de captação "quero abrir minha empresa" da landing de Curitiba. */
  ...
  const handleFinish = async () => {
    ...
    try {
      ...
      await criarLead({
        ...
        observacoes: `Situação: ${dados.situacao}${dados.observacoes ? ` · ${dados.observacoes}` : ''} (modal abrir empresa — landing Psicólogos Curitiba)`,
      });
              ...
              <>
                ...
                <Field.RadioGroup
                  ...
                  options={[
                    ...
                    { label: 'Atendo como autônomo(a) e quero avaliar', value: 'autonomo' },
                  ]}
                />
                <Field.Text
                  name="observacoes"
