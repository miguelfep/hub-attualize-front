...
import { fBRL, fPct, parseMoedaBR, mascaraMoedaBR, calcularFatorR, LIMIAR_FATOR_R } from './fator-r';
      ...
      <Box sx={{ position: 'relative', pt: 3.5, pb: 4 }}>
        ...
        >
          ...
          <Box
            sx={{
              ...
              width: `${posicao}%`,
              borderRadius: 7,
              bgcolor: acima ? CORES.verde : CORES.rosa,
        ...
        <Box
          sx={{
            ...
            borderBottom: `9px solid ${acima ? CORES.verde : CORES.rosa}`,
          }}
        />
  ...
  return (
    <Box
      sx={{
        ...
        borderRadius: 2,
        border: '2px solid',
        borderColor: ativo ? CORES.rosa : '#EBE1DB',
...
export function CalculadoraFatorR() {
  ...
  const mensagemWhats = resultado
    ? `Olá! Simulei meu Fator R na página de Psicólogos em Curitiba: receita 12m ${fBRL(resultado.receita12)}, folha 12m ${fBRL(resultado.folha12)} → Fator R ${fPct(resultado.fatorR)} (Anexo ${resultado.anexo}, alíquota efetiva ${fPct(resultado.anexo === 'III' ? resultado.efetivaIII : resultado.efetivaV)}). Quero otimizar meu Fator R com a Attualize.`
    : '';
  ...
  return (
    <Box
      ...
      sx={{ py: { xs: 6, md: 10 }, bgcolor: CORES.rosaSuave, scrollMarginTop: 96 }}
    >
      <Container maxWidth="md">
        <Stack spacing={1} sx={{ textAlign: 'center', mb: 4 }}>
          <Typography
            variant="overline"
            sx={{ color: CORES.rosa, letterSpacing: 1.5, fontWeight: 700 }}
          >
          ...
          <Typography variant="body1" sx={{ color: CORES.grafite, maxWidth: 560, mx: 'auto' }}>
            O Fator R define se sua empresa paga imposto pelo Anexo III (a partir de 6%) ou pelo
            Anexo V (a partir de 15,5%) do Simples Nacional. Simule com seus números.
          </Typography>
        </Stack>
        ...
        <Box
          sx={{
            ...
            boxShadow: '0 16px 40px -24px rgba(42, 22, 32, 0.35)',
          }}
        >
          <Stack spacing={2.5}>
            <ToggleButtonGroup
            ...
            <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2}>
              <TextField
                ...
                inputMode="decimal"
                placeholder={modo === 'anual' ? '300.000,00' : '25.000,00'}
                ...
                <Stack spacing={3} sx={{ pt: 1 }}>
                  ...
                  >
                    <Typography component="h3" variant="h4" sx={{ color: CORES.tinta }}>
                      ...
                      <Box
                        component="span"
                        sx={{ color: noAnexoV ? CORES.rosa : CORES.verde }}
                      >
                  ...
                  <Typography variant="caption" sx={{ color: CORES.grafite, textAlign: 'center' }}>
                    Simulação simplificada, não substitui análise contábil individualizada.
                  </Typography>
                </Stack>
              )}
            </Collapse>
