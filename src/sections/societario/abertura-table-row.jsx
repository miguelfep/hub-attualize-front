...
export function AberturaTableRow({
  row,
  selected,
  onSelectRow,
  onViewRow,
  ...
  return (
    <>
      <TableRow hover selected={selected}>
        ...
        <TableCell>
          <ListItemText
            primary={fDate(row.dataAbertura)}
        ...
        <TableCell>
          <Label
            variant="soft"
            color={
              (row.statusAbertura === 'finalizado' && 'success') ||
              (row.statusAbertura === 'em_constituicao' && 'secondary') ||
              (row.statusAbertura === 'iniciado' && 'warning') ||
              'default'
            }
          >
            {row.statusAbertura}
