...
export function MaterialTableRow({ row, selected, onSelectRow, onViewRow, onEditRow, onDeleteRow }) {
  return (
    <TableRow hover tabIndex={-1} role="checkbox" selected={selected}>
      ...
      <TableCell>
        <Label variant="soft">{getTipoLabel(row.tipo)}</Label>
      </TableCell>
      ...
      <TableCell align="center">
        <Typography variant="body2">{row.downloads || 0}</Typography>
      </TableCell>
