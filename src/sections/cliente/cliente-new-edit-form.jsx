...
export const NewUClienteSchema = zod.object({
  ...
  apuracaoSerproAtiva: zod.boolean().optional(),
  apuracaoIdAtividade: zod.number().int().positive().nullable().optional(),
...
export function ClienteNewEditForm({ currentCliente }) {
  ...
  const defaultValues = useMemo(
    () => ({
      ...
      apuracaoSerproAtiva: currentCliente?.apuracaoSerproAtiva || false,
      apuracaoIdAtividade: currentCliente?.apuracaoIdAtividade ?? null,
