  ...
  return (
    <Box
      ...
      sx={{
        ...
        overflow: 'hidden',
        bgcolor: CORES.papel,
        borderBottom: '1px solid #E2EDF3',
        py: { xs: 8, md: 12 },
        // Mesmo fundo das demais landings, com lavagem fria da paleta local
        '&::before': {
          content: '""',
          position: 'absolute',
          inset: 0,
        ...
        '&::after': {
          ...
          inset: 0,
          background:
            'linear-gradient(135deg, rgba(246, 250, 252, 0.85) 0%, rgba(227, 241, 250, 0.75) 100%)',
          zIndex: 0,
        },
      ...
      <Container maxWidth="lg">
        <Stack direction={{ xs: 'column', md: 'row' }} spacing={{ xs: 5, md: 8 }} alignItems="center">
          <Stack spacing={3} sx={{ flex: 1 }}>
            <Typography
              variant="overline"
              sx={{ color: CORES.azul, letterSpacing: 2, fontWeight: 700 }}
            >
            ...
            <Typography variant="h6" component="p" sx={{ color: CORES.grafite, fontWeight: 400 }}>
              Pague menos imposto com o Fator R e a equiparação hospitalar bem aplicados, e tenha
              uma contabilidade que entende a rotina de quem atende: plantões PJ, convênios, CRM,
              NFS-e e Simples Nacional — tudo digital, sem você sair do consultório.
            </Typography>
            ...
            <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2}>
              ...
              <Button
                ...
                sx={{
                  ...
                  '&:hover': { borderColor: CORES.azul, color: CORES.azul, bgcolor: 'transparent' },
          ...
          <Box
            ...
            sx={{
              ...
              boxShadow: '0 24px 48px -32px rgba(15, 36, 48, 0.35)',
            }}
          >
            ...
            <Typography variant="h3" sx={{ color: CORES.tinta, my: 1 }}>
              15,5% <Box component="span" sx={{ color: CORES.azul }}>→</Box> 6%
            </Typography>
            ...
            <Box sx={{ position: 'relative', height: 12, borderRadius: 6, bgcolor: '#E4EDF2' }}>
              <Box
                sx={{
                  position: 'absolute',
                  inset: 0,
