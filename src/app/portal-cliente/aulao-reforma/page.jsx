...
const HERO_DESCRIPTION =
  'Assista ao Aulão Reforma exclusivo para clientes Attualize. Compartilhe seu feedback e nos ajude a construir conteúdos cada vez melhores!';
    ...
    <Container maxWidth="md" sx={{ py: { xs: 6, md: 8 } }}>
      <Stack spacing={4}>
        ...
        {!loadingEmpresas && !clienteProprietarioId && (
          <Alert severity="info">
            Vincule ou selecione uma empresa para registrar sua avaliação.
          </Alert>
        )}
