...
const HERO_DESCRIPTION =
  'Assista ao Aulão Hub do Cliente exclusivo para clientes Attualize e compartilhe seu feedback com o nosso time.';

const AULAO_HUB_CLIENTE_ID = process.env.NEXT_PUBLIC_AULAO_HUB_CLIENTE_ID || null;
...
export default function AulaoHubClientePage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (AULAO_HUB_CLIENTE_ID) {
        payload.referenciaId = AULAO_HUB_CLIENTE_ID;
      }
    ...
    <Container maxWidth="md" sx={{ py: { xs: 6, md: 8 } }}>
      <Stack spacing={4}>
        <Stack spacing={1.5}>
          ...
          <Typography variant="h3">Aulão Hub do Cliente</Typography>
        ...
        <Card sx={{ overflow: 'hidden', borderRadius: 3 }}>
          ...
          >
            <Box
              component="iframe"
              src="https://www.youtube.com/embed/T-84s6QszpE"
            ...
            <Stack spacing={2.5}>
              <Stack spacing={1}>
                ...
                <Typography variant="body2" color="text.secondary">
                  Conte pra gente o que achou do Aulão Hub do Cliente. Sua opinião é muito importante!
                </Typography>
              </Stack>
              ...
              <Stack direction={{ xs: 'column', sm: 'row' }} spacing={3} alignItems={{ sm: 'center' }}>
                <Stack direction="row" spacing={1} alignItems="center">
                  ...
                  <Stack spacing={0.5}>
                    ...
                    <Typography variant="body2" color="text.secondary">
                      Como voce avalia essa aula?
                    </Typography>
                  </Stack>
                </Stack>

                <Rating
                  name="aulao-hub-cliente-rating"
                  value={nota}
                  precision={1}
        ...
        <Card sx={{ borderRadius: 3 }}>
          <CardContent>
            <Stack spacing={2.5}>
              <Stack spacing={1}>
                <Typography variant="h5">O que os clientes estao dizendo</Typography>
                <Typography variant="body2" color="text.secondary">
                  Veja os comentários e notas já enviados para o Aulão Hub do Cliente.
                </Typography>
              </Stack>
