...
import { DENTISTAS } from 'src/sections/saude/segment/data/dentistas';
import { buildSegmentJsonLd, buildSegmentMetadata } from 'src/sections/saude/segment/segment-seo';

// ----------------------------------------------------------------------

export const metadata = buildSegmentMetadata(DENTISTAS);
...
export default function Page() {
  const jsonLd = buildSegmentJsonLd(DENTISTAS);
  ...
  return (
    <section>
      ...
      />
      <SegmentLandingView segment={DENTISTAS} />
    </section>
  );
}
