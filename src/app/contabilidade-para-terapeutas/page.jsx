...
import { TERAPEUTAS } from 'src/sections/saude/segment/data/terapeutas';
import { buildSegmentJsonLd, buildSegmentMetadata } from 'src/sections/saude/segment/segment-seo';

// ----------------------------------------------------------------------

export const metadata = buildSegmentMetadata(TERAPEUTAS);
...
export default function Page() {
  const jsonLd = buildSegmentJsonLd(TERAPEUTAS);
  ...
  return (
    <section>
      ...
      />
      <SegmentLandingView segment={TERAPEUTAS} />
    </section>
  );
}
