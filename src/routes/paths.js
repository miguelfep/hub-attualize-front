...
export const paths = {
  ...
  saudeHome: '/contabilidade-para-negocios-da-area-da-saude',
  medicosHome: '/contabilidade-para-medicos',
  dentistasHome: '/contabilidade-para-dentistas',
  fisioterapeutasHome: '/contabilidade-para-fisioterapeutas',
  nutricionistasHome: '/contabilidade-para-nutricionistas',
  ...
  dashboard: {
    ...
    attualizeConfig: {
      root: `${ROOTS.DASHBOARD}/attualize-config`,
    },
    banners: {
    ...
    usuarios: {
      ...
      internos: `${ROOTS.DASHBOARD}/usuarios/internos`,
    },
    contratos: {
