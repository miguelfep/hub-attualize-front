...
export const endpoints = {
  ...
  // no repo ms-me. Stream SSE e download de anexo precisam do token na URL/Bearer.
  chatInterno: {
    ...
    arquivados: `${baseUrl}chat/canais/arquivados`,
    arquivar: (id) => `${baseUrl}chat/canais/${id}/arquivar`,
    desarquivar: (id) => `${baseUrl}chat/canais/${id}/desarquivar`,
    membros: (id) => `${baseUrl}chat/canais/${id}/membros`,
    membro: (id, userId) => `${baseUrl}chat/canais/${id}/membros/${userId}`,
    entrar: (id) => `${baseUrl}chat/canais/${id}/entrar`,
    sair: (id) => `${baseUrl}chat/canais/${id}/sair`,
    dms: `${baseUrl}chat/dms`,
    lido: (id) => `${baseUrl}chat/canais/${id}/lido`,
    mensagens: (id) => `${baseUrl}chat/canais/${id}/mensagens`,
    anexos: (id) => `${baseUrl}chat/canais/${id}/anexos`,
    mensagem: (id) => `${baseUrl}chat/mensagens/${id}`,
    thread: (id) => `${baseUrl}chat/mensagens/${id}/thread`,
    reacoes: (id) => `${baseUrl}chat/mensagens/${id}/reacoes`,
    anexo: (id, idx) => `${baseUrl}chat/mensagens/${id}/anexos/${idx}`,
    waIniciar: (id) => `${baseUrl}chat/canais/${id}/wa/iniciar`,
  },
  queues: {
  ...
  guiasFiscais: {
    ...
    portal: {
      ...
      /** §6.4 — competência obrigatória; servidor cria contabil / ano / MM */
      contabilUpload: `${baseUrl}portal/guias-fiscais/contabil/upload`,
